...
**단, Window는 로컬 설치 시 문제가 있어 글로벌로 설치**합니다.  
...
Native 방식이 권고되고 안되면 NPM 방식으로 설치.
...
Window:  
글로벌로 설치.   
'~/.npm-global/claude'파일이 생깁니다.   
위 경로를 PATH에 추가 하지 않았으면 아래 링크를 참조하여 추가해 주세요.    
...
**2.글로벌 버전만 설치된 경우(Linux/Mac에 과거 설치한 사용자만 수행)**    
**주의) 최초설치한 사람은 수행하지 마세요.**       
...
**3.글로벌/로컬 버전 모두 설치된 경우(Linux/Mac에 과거 설치한 사용자만 수행)**   
**주의) 최초설치한 사람은 수행하지 마세요.**   
1)현재 설치 상태 진단   
...
7번 눌러 MCP설치 Skip.    
![](images/2025-09-22-22-14-14.png)

3번 눌러 SuperClaude Command만 설치.   
![](images/2025-09-22-22-14-59.png)

y 누르고 또 Y 눌러 설정 완료     
![](images/2025-09-22-22-16-16.png)
