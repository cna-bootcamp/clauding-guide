...
## 목차
- [VM 생성 및 필요툴 설치](#vm-생성-및-필요툴-설치)
  - [목차](#목차)
  - [VM 생성](#vm-생성)
  - [VM 접근](#vm-접근)
  - [Azure CLI 설치](#azure-cli-설치)
  - [Azure Login](#azure-login)
  - [Azure 전역 설정](#azure-전역-설정)
...
주의) MobaXTerm에서는 Drag만 하면 클립보드에 복사가 됩니다. CTRL-C를 누르면 중단되므로 drag만 하세요.   
...
Alias등록   
기본 편집기에서 '.bashrc'파일을 엽니다.   
![](images/2025-09-02-00-45-01.png)

맨 끝에 alias k=kubectl 추가  
![](images/2025-09-01-22-52-22.png)  

파일을 저장합니다.  
최초에는 업로드 여부를 물어보는데 가운데 버튼을 눌러 앞으로는 물어보지 않게 합니다.   
자동으로 서버에 변경사항이 반영됩니다.  
...
- JDK 압축파일 다운로드   
  소스코드에서 사용한 JDK버전과 동일한 JDK버전을 설치하십시오.    
  최상위 build.gradle에서 버전을 확인할 수 있습니다.   

  아래 사이트에 접속해서 사용한 버전의 다운로드 링크를 복사하여 압축파일을 다운로드 합니다.  
  https://jdk.java.net/archive/ 
    
  ![](images/2025-09-02-01-04-01.png)   
  ![](images/2025-09-02-01-04-30.png)  
  

  아래는 JDK21을 사용했을때의 예시입니다.   
  ```
  cd ~
...
- '.bashrc' 파일에 추가 
  ```
  JAVA_HOME=/home/azureuser/jdk-21
