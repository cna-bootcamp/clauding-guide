...
#### 시퀀스 설계
- 프로토타입을 먼저 보여주고 설계를 하는것도 좋음 
- 시퀀스 설계 결과 검토 시 
관련된 프로토타입 화면을 보고 개선하라고 하는게 좋음 
예)
```
...
```
@test-front 프로토타입을 웹브라우저의 'Samsung Galaxy S8+'모드에서 테스트 해주십시오. 대시보드 화면부터 시작하십시오.    
```
