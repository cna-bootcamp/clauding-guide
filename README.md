...
#### 백엔드 테스트  
백엔드 테스트는 **각 API별로 하나 하나 테스트** 합니다.   
...
~/.idea/workspace.xml에 등록됩니다.    
등록이 되면 서비스탭에 나타납니다.    
![](images/2025-08-07-09-23-54.png)  
먼저 실행구성을 클릭하고 'Gradle'이나 'Maven' 등 빌드툴을 선택해야 표시됩니다.   
![](images/2025-08-07-09-24-30.png)    

**3.실행 프로파일 자동작성 버그 해결**         
Claude Code가 실행 프로파일을 업데이트할 때 모든 정보가 정상인데 이상하게 꼬이는 경우가 있습니다.   
![](images/2025-08-07-09-29-11.png)   

이때는 실행 > 구성편집을 실행하여 문제가 있는 프로파일을 복사하고 테스트 한 후 기존 프로파일을 삭제하면 됩니다.   
![](images/2025-08-07-09-27-25.png)  

![](images/2025-08-07-09-30-33.png)  

![](images/2025-08-07-09-31-08.png)  
